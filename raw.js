const net = require("net");
 ...
 if (process.argv.length < 8){
    console.log(`\x1b[37m - node raw.js url time rate threads proxyfile \x1b[31mGET\x1b[37m/\x1b[35mPOST\x1b[37m/\x1b[35mFLOOD \x1b[37m!\x1b[0m`);
    process.exit();
 }
 let val 
 let isp
 ...
 if (cluster.isMaster) {
    ...
    console.clear();
    console.log(` Made By @SaToRuz \x1b[31mwith luv <3\x1b[0m`)
